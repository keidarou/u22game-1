...
public class GetAcc : MonoBehaviour {
	...
	void Update () {
		...
		float ru = Mathf.Atan2 (Screen.height/2.0f, Screen.width/2.0f);
		float lu = Mathf.Atan2 (Screen.height/2.0f, -Screen.width/2.0f);
		float ld = Mathf.Atan2 (-Screen.height/2.0f, -Screen.width/2.0f);
		float rd = Mathf.Atan2 (-Screen.height/2.0f, Screen.width/2.0f);
